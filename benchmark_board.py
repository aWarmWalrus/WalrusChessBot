...
def boardInitialization():
    board = Array2DBoard()
    board.setPositionWithFen(STARTING_FEN)

def startposMoves(moves):
    board = Array2DBoard()
    board.setPositionWithFen(STARTING_FEN)
    for move in moves:
...
if __name__ == '__main__':
    ...
    test2 = timeit.timeit("startposMoves(moves50)", globals=locals(), number=1000)
    test3 = timeit.timeit("startposMoves(moves100)",globals=locals(), number=1000)
