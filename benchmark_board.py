...
def boardInitialization():
    board = Array2DBoard.createFromFen(STARTING_FEN)

def bitboardInitialization():
...
if __name__ == '__main__':
    ...
    test1 = timeit.timeit("boardInitialization()", globals=locals(), number=1000) * 1000
    test2 = timeit.timeit("startposMoves(moves50, arrayBoard)", globals=locals(), number=1000)
    test3 = timeit.timeit("startposMoves(moves100, arrayBoard)",globals=locals(), number=1000)

    print("Array2DBoard")
    print("  boardInitialization: {}µs".format(test1))
    print("  startposMoves(50): {}ms".format(test2))
    print("  startposMoves(100): {}ms".format(test3))

    bitBoard = BitBoard.createFromFen(STARTING_FEN)

    test4 = timeit.timeit("bitboardInitialization()", globals=locals(), number=1000) * 1000
    test5 = timeit.timeit("startposMoves(moves50, bitBoard)", globals=locals(), number=1000)
    test6 = timeit.timeit("startposMoves(moves100, bitBoard)",globals=locals(), number=1000)

    print("BitBoard:")
    print("  boardInitialization: {}µs".format(test4))
    print("  startposMoves(50): {}ms".format(test5))
    print("  startposMoves(100): {}ms".format(test6))
